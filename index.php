						...
						<div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="slide-content">
                                    ...
                                    <div class="layer-1-3">
                                        <a href="login.php" class="ready-btn left-btn" >Get started</a>
               ...
               <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
                            <h3>Why choose Paynowonline plateform</h3>
                    ...
                    <div class="support-all">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="about-contact text-center">
                                <div class="about-btn">
                                    <a class="ab-btn left-ab-btn" href="about.php">More about us</a>
                                    <a class="ab-btn right-ab-btn" href="about.php">Create an account</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="services-area area-padding-2">
            <div class="container">
               <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="section-headline text-center">
                            <h3>Paynowservices worldwide</h3>
                            <p>Help agencies to define their new business objectives and then create professional software.</p>
						</div>
					</div>
				</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="feature-text">
                            ...
                            <a class="feature-btn" href="login.php">Get started now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="brand-content">
                           ...
                           <a class="hire-btn" href="login.php">Get started</a>
                        </div>
                    </div>
                </div>
            </div>
